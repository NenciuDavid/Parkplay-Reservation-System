...
class ApiService {
  ...
  Future<Reservation?> fetchNextExpiringReservation(int lotId) async {
    final response = await http.get(Uri.parse('$baseUrl/reservations/lot/$lotId/next-expiring'));
    ...
    if (response.statusCode == 200) {
      ...
      throw Exception('Eroare la încărcarea următoarei rezervări.');
    }
  }
}