...
import 'package:parkplay_frontend/models/reservation.dart';
...
class _ManagerDashboardState extends State<ManagerDashboard> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      // Aici am scos FutureBuilder-ul si am lasat doar lista curata
      body: Padding(
    ...
    return Scaffold(
      ...
      body: _isLoading 
          ...
          : Column(
              children: [
                // ==========================================
                // CARDUL NOSTRU PORTOCALIU MUTAT AICI (BINOMIAL HEAP)
                // ==========================================
                Padding(
                  padding: const EdgeInsets.all(16.0),
                  child: FutureBuilder<Reservation?>(
                    future: _apiService.fetchNextExpiringReservation(widget.lot.id), // Apelăm pe parcarea curentă
                    builder: (context, snapshot) {
                      ...
                      if (snapshot.hasError || !snapshot.hasData || snapshot.data == null) {
                        return const Card(
                          child: ListTile(
                            ...
                            title: Text('Nicio rezervare activă pe această parcare.'),
                          ),
                        );
                      }
                      ...
                      // Căutăm Numele locului în lista de locuri a parcării
                      String spotName = "Necunoscut";
                      try {
                        spotName = _spots.firstWhere((s) => s.id == res.spotId).spotNumber;
                      } catch (e) {}
                      ...
                      return Card(
                        ...
                        child: ListTile(
                          ...
                          title: const Text(
                            'Următorul loc care se eliberează:',
                            style: TextStyle(fontWeight: FontWeight.bold, color: Colors.orange),
                          ),
                          subtitle: Text(
                            'Locul: $spotName\nExpiră la: ${res.endTime.toString().substring(0, 16)}',
